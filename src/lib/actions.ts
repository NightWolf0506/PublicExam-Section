...
export const createTeacher = async (
  ...
  console.log("Create Teacher Data:", data);
  ...
  try {
    ...
    const user = await (await clerkClient()).users.createUser({
      ...
      emailAddress: [data.email], // Ensure email is passed as an array
...
export const createAnnouncement = async (data: FormData) => {
  try {
    console.log("Creating announcement with data:", Object.fromEntries(data.entries()));
    const title = data.get("title") as string;
    const description = data.get("description") as string;
    const date = new Date(data.get("date") as string);
    const classId = data.get("classId") ? parseInt(data.get("classId") as string) : null;
...
export const updateAnnouncement = async (data: FormData) => {
  try {
    console.log("Updating announcement with data:", Object.fromEntries(data.entries()));
